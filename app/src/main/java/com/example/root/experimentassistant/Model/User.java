...
//    Activity callActivity;
    ...
    public boolean Login(String Id,String Pass){
        ...
        ExperimentHttpClient.getInstance().post("student/login",params,new JsonHttpResponseHandler()
        {
            @Override
    ...
    public int Register(String Id,String Name,String PhoneNum,String VertifyCode,String Pass) {
        ...
        ExperimentHttpClient.getInstance().post("student/register", params, new TextHttpResponseHandler() {
            @Override
    ...
    public List<ViewExper> getCntExper(int week,final RequestCallBack callBack){
        ...
        ExperimentHttpClient.getInstance().post("student/expers",params,new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    JSONArray jsonArray = response.getJSONArray("expers");
            ...
            public void onFailure(int v1, Header[] v2, Throwable v3 , JSONObject v4){
                ...
                if(callBack!=null) callBack.onRequestFailure(User.getInstance());
            }
        });
