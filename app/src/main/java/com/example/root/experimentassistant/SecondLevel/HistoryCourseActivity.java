...
public class HistoryCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentInfo.getMyCourseHistory(new RequestCallBack() {
            @Override
            public void onRequestSuccess(Object sender) {
                List<ViewCourse> courses=(List<ViewCourse>)sender;
                CoursesAdapter adapter=new CoursesAdapter(HistoryCourseActivity.this,courses);
            ...
            public void onRequestFailure(Object sender) {
                ...
                Log.d("HistoryCourseAct","fail"+status);
            }
        });
