...
import com.example.root.experimentassistant.Adapter.ScoresAdapter;
...
public class MyScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentInfo.getMyExperScore(new RequestCallBack() {
            @Override
            public void onRequestSuccess(Object sender) {
                List<ViewExperScore> courses=(List<ViewExperScore>)sender;
                ScoresAdapter adapter=new ScoresAdapter(MyScoreActivity.this,courses);
